import { NotificationOption, NotificationsResponse, Permission, PermissionStatus, RequestOptions } from './types';
export interface Contract {
    openSettings(): Promise<void>;
    check(permission: Permission): Promise<PermissionStatus>;
    request<T extends Permission>(permission: T, options?: RequestOptions<T>): Promise<PermissionStatus>;
